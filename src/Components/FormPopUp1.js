...
import {setData, updateData} from '../Actions/ActionFile';
      ...
      if (selectedItem && selectedItem.email !== null) {
        ...
        for (var i in userData) {
          if (userData[i].email === sel_email) {
            ...
            // console.log('in edit', userData[i]);
            // props.setData(userData[i]);
...
const mapStateToProps = (state) => {
  console.log('state in formpopup', state.apiReducer);
  return {
    users: state.apiReducer.user,
  };
};

export default connect(mapStateToProps, {setData, updateData})(FormPopup);
